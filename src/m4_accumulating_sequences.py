...
def main():
    ...
    # ------------------------------------------------------------------
    # TO: 8. Uncomment the tests below before working TO DO 9.
...
def run_test_make_less_simple_string():
    ...
    # ------------------------------------------------------------------
    # TO: 6. Implement this TEST function.
...
def draw_shapes(shapes, window):
    ...
    # ------------------------------------------------------------------
    # TO: 9. Implement and test this function. Make sure you do TO DO 8 in main first!
...
def rectangles_from_circles(circles):
    ...
    for k in range(len(circles)):
        rectangles=rectangles+[circles[k].get_bounding_box()]
    return rectangles
    # ------------------------------------------------------------------
